...
import { parseKitUnitPrice, parseKitWeightGrams } from "@/lib/kits-category";
  ...
  try {
    ...
    const products = rows.map((p) => {
      ...
      return {
        ...
        unit_price: parseKitUnitPrice(row.unit_price),
        weight_grams: parseKitWeightGrams(row.weight_grams),
      };
    });
